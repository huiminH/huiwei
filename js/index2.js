window.onload = function(){
    ...
    $.ajax({
        ...
        success:function(res){
            ...
            for(var key in res){
            //    console.log(key);
            str3 = '<li class="duct-d"><a href="#"><img class="img1" src="image/computer.png" alt=""></a></li>';
            for(var i = 0;i < res[key].list.length;i++){
    ...
    $.ajax({
        ...
        success:function(res){
            var str4= "";
            str4 = '<li class="duct-d"><a href="#"><img class="img1" src="image/flag.png" alt=""></a></li>';
            for(var key in res){
            //    console.log(key);
            for(var i = 0;i < res[key].list.length;i++){
    ...
    $.ajax({
        ...
        success:function(res){
            // console.log(res);
            var str5= "";
            str5 = '<li class="duct-d" id="wr"><a href="#"><img class="img1" src="image/smart.png" alt=""></a></li>';
            for(var key in res){
                for(var i = 0;i < res[key].list.length;i++){
    ...
    $.ajax({
        ...
        success:function(res){
            // console.log(res);
            var str7= "";
            str7 = '<li class="duct-d" id="wr"><a href="#"><img class="img1" src="image/home.png" alt=""></a></li>';
            for(var key in res){
                for(var i = 0;i < res[key].list.length;i++){
    ...
    $.ajax({
        ...
        success:function(res){
            // console.log(res);
            var str9= "";
            str9 = '<li class="duct-d" id="wr"><a href="#"><img class="img1" src="image/sell.png" alt=""></a></li>';
            for(var key in res){
                for(var i = 0;i < res[key].list.length;i++){
    ...
    $.ajax({
        ...
        success:function(res){
            // console.log(res);
            var num1= "";
            num1 = '<li class="duct-d" id="wr"><a href="#"><img class="img1" src="image/brand.png" alt=""></a></li>';
            for(var key in res){
                for(var i = 0;i < res[key].list.length;i++){
